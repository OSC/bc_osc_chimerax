...
%global repo_name bc_osc_chimerax
%global app_name bc_osc_chimerax
...
Summary:  Batch Connect - OSC ChimeraX 
...
%description
A Batch Connect app designed for OSC OnDemand that launches ChimeraX within an Owens batch job.
